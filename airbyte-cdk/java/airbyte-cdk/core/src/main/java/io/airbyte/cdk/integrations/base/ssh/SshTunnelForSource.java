...
import io.airbyte.cdk.integrations.config.AirbyteConfig.AirbyteConfigBuilder;
...
public class SshTunnelForSource extends SshTunnel<AirbyteSourceConfig> {
  ...
  public SshTunnelForSource(final AirbyteSourceConfig config,
    ...
    super(config, hostKey, portKey, endPointKey, remoteServiceUrl, tunnelMethod, tunnelHost, tunnelPort, tunnelUser, sshKey, tunnelUserPassword, remoteServiceHost, remoteServicePort);
  ...
  public AirbyteSourceConfig getConfigInTunnel() throws Exception {
    if (tunnelMethod.equals(TunnelMethod.NO_TUNNEL)) {
      ...
      final AirbyteConfigBuilder<AirbyteSourceConfig> clone = config.cloneBuilder();
      if (hostKey != null) {
  ...
  public static SshTunnelForSource getInstance(final AirbyteSourceConfig config, final String endPointKey) throws Exception {
