...
public class RecordWaitTimeUtilTest {
  ...
  void testGetFirstRecordWaitTime() {
    ...
    final AirbyteSourceConfig normalConfig = AirbyteSourceConfig.of("replication_method",
    ...
    final AirbyteSourceConfig tooShortConfig = AirbyteSourceConfig.of("replication_method",
    ...
    final AirbyteSourceConfig tooLongConfig = AirbyteSourceConfig.of("replication_method",
