...
public class JdbcDataSourceUtilsTest {
  ...
  void test() {
    ...
    final AirbyteSourceConfig validConfig = AirbyteSourceConfig.fromJsonString(validConfigString);
    ...
    final AirbyteSourceConfig invalidConfig = AirbyteSourceConfig.fromJsonString(invalidConfigString);
